...
https://s3.amazonaws.com/fandeavor/rdoc/fig1.png
...
https://s3.amazonaws.com/fandeavor/rdoc/fig2.png

List View of the traces (above) and the Detail View of an individual trace(below).

https://s3.amazonaws.com/fandeavor/rdoc/fig3.png
...
1. Add <tt>gem 'aws-sdk'</tt> to the Gemfile
2. Add  <tt>gem 'aws-xray-sdk', require: ['aws-xray-sdk/facets/rails/railtie']</tt>
3. Add to the file <tt>config/initializers/aws_xray.rb</tt>
...
4. A client will need to be installed on the system running the rails app.  For local one can be downloaded and for the beanstalk environment will need to include the config file in <tt>.ebextensions/xray-daemon.config</tt>
  option_settings:
